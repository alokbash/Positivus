...
import 'piccolore';
import { $ as $$Image } from '../chunks/_astro_assets_Bud8IZuo.mjs';
import { $ as $$Card } from '../chunks/Card_D2mzjQlu.mjs';
import { b as $$Section, c as $$SectionTitle, $ as $$Sponsors, a as $$Services } from '../chunks/Services_Bg0b0bwp.mjs';
import { l as larrow } from '../chunks/icon3_BVK5Biin.mjs';
/* empty css                                 */
import { c as createSvgComponent, $ as $$MainLayout } from '../chunks/MainLayout_faaIDIQw.mjs';
import 'clsx';
...
}, "C:/Positivus/src/components/sections/Cases.astro", void 0);
...
const decorForm = new Proxy({"src":"/_astro/contact-pic.BrB0SfUf.png","width":692,"height":649,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Positivus/src/assets/pics/contact-pic.png";
							}
...
}, "C:/Positivus/src/components/sections/Hero.astro", void 0);
  ...
  const content = [
    {
      ...
      description: "While co-location is ideal for Agile teams, it's often not feasible for technical writers. We begin each project with a kick-off meeting to review documentation scope, backlogs, release goals, and create a communication plan. We agree on the planning tool to track tasks and present documentation at the end of the sprint."
    },
    {
      index: 2,
      title: "Backlog Review and Task Definition",
      description: "After setting the communication plan, we review the product backlog and conduct a product audit to assess current documentation and new requirements. We define tasks, get client sign-off, and agree on tools, source control, and delivery methods."
    },
    {
      index: 3,
      title: "User Analysis and Document Structuring",
      description: "We analyze user personas and product usage before creating documentation. We draft a TOC for each document, focusing on three information types: Concept, Task, and Reference. Once approved, we move into sprints."
    },
    {
      index: 4,
      title: "Template Creation and Writing Standards",
      description: "We build document templates that follow brand guidelines and favor minimalism so users can find information quickly. Our writers often use DITA and docs-as-code. We also create a style guide to ensure consistency across all documentation, covering tone, voice, formatting, and terminology."
    },
    {
      index: 5,
      title: "Collaboration and Sprint Execution",
      description: "As part of scrum teams, we attend planning meetings, create documentation tasks, and author self-contained topics. We use collaboration tools to gather input, send drafts for technical review, and encourage marking user stories as NOT DONE if documentation is incomplete."
    },
    {
      index: 6,
      title: "Review, Approval, and Publication",
      description: "We rigorously review writing, graphics, and links for accuracy and style. At sprint review, we demo the documentation, and once accepted, we publish it."
    }
  ];
...
}, "C:/Positivus/src/components/ui/Accordion.astro", void 0);
...
}, "C:/Positivus/src/components/sections/Process.astro", void 0);
...
const propImg = new Proxy({"src":"/_astro/proposal-pic.DC7YnBHg.png","width":494,"height":395,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Positivus/src/assets/pics/proposal-pic.png";
							}
...
}, "C:/Positivus/src/components/ui/TeamCard.astro", void 0);
...
const p1 = new Proxy({"src":"/_astro/t1.DCqpUh7U.png","width":106,"height":103,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Positivus/src/assets/team/t1.png";
							}
...
const p2 = new Proxy({"src":"/_astro/t2.nG-pfUKH.png","width":103,"height":103,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Positivus/src/assets/team/t2.png";
							}
...
const p3 = new Proxy({"src":"/_astro/t3.CD1xqxr1.png","width":103,"height":103,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Positivus/src/assets/team/t3.png";
							}
...
const p4 = new Proxy({"src":"/_astro/t4.H_8Q79jb.png","width":103,"height":103,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Positivus/src/assets/team/t4.png";
							}
...
const p5 = new Proxy({"src":"/_astro/t5.hcMJufQa.png","width":103,"height":103,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Positivus/src/assets/team/t5.png";
							}
...
const p6 = new Proxy({"src":"/_astro/t6.C1epwtLh.png","width":103,"height":103,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Positivus/src/assets/team/t6.png";
							}
...
}, "C:/Positivus/src/components/sections/Team.astro", void 0);
...
}, "C:/Positivus/src/components/sections/Testimonials.astro", void 0);
...
}, "C:/Positivus/src/pages/index.astro", void 0);

const $$file = "C:/Positivus/src/pages/index.astro";
const $$url = "";
